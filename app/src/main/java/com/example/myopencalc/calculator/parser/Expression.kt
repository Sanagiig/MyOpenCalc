...
class Expression {
    ...
    fun getCleanExpression(
        calculation: String, decimalSeparatorSymbol: String, groupingSeparatorSymbol: String
    ): Any {
 ...
 */
    private fun getPercentString(calculation: String): String {
        ...
        val operatorBeforePercentPos = calculation.subSequence(0, percentPos)
        ...
        if (calculation[operatorBeforePercentPos] == ')') {
            ...
            if (openParenPos > 0) {
                ...
                return calculationStringFirst + calculation[operatorBeforeParen] + calculationStringFirst + "*(" + calculation.subSequence(
                    openParenPos + 1,
                    percentPos - 1
